...
export const PROVIDERS: Record<AIProvider, ProviderConfig> = {
  openai: {
    ...
    parameters: [
      ...
      { key: 'max_tokens', label: 'Max Tokens', description: '생성할 최대 토큰 수. 추론 모델은 내부적으로 max_completion_tokens로 전달됩니다.', min: 1, max: 16384, step: 1, defaultValue: 1024 },
  ...
  anthropic: {
    ...
    models: [
      ...
      { id: 'claude-opus-4-1-20250805', name: 'Claude Opus 4.1', supportsImages: true, maxTokens: 200000 },
      ...
      { id: 'claude-3-haiku-20240307', name: 'Claude Haiku 3 (Deprecated)', supportsImages: true, maxTokens: 200000 },
    ],
    parameters: [
